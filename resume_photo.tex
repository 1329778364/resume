...
\Large{
  \begin{tabu}{ c l r }
   \multirow{5}{1in}{\includegraphics[width=0.88in]{avatar}} & \scshape{Wang liqiang} & {Python~}\progressbar{0.75} \\
    ...
    & \Github[DeepMan]{https://github.com/1329778364} & {Flask~}\progressbar{0.5} \\
    & \CSDN[github.com/billryan]{https://blog.csdn.net/weixin_37206602} & {Javascript~}\progressbar{0.5}
  \end{tabu}
}
