...
\Large{
  \begin{tabu}{ c l r }
   \multirow{5}{1in}{\includegraphics[width=0.88in]{picture.jpg}} & \scshape{wang liqiang} & {Python~}\progressbar{0.75} \\
    & \email{wlq18895375022@gmail.com} & {Scala~}\progressbar{0.5} \\
    & \phone{(+86) 188-9537-5022} & {Linux~}\progressbar{0.7} \\
    & \linkedin[billryan8]{https://www.linkedin.com/in/billryan8} & {Flask~}\progressbar{0.5} \\
    & \github[github.com/1329778364]{https://github.com/1329778364} & {Javascript~}\progressbar{0.5}
  \end{tabu}
}
